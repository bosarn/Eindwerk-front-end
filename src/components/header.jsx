...
export default ({ checker, checked }) => {
  ...
  //function to show amount shopping cart items in stead of only the items
      ...
      <Toolbar className={classes.toolbar}>
        ...
        {matches ? (
          <div className={classes.Title}>
            <Typography variant="h2">3D-PrintDomain</Typography>
          ...
          <ul className={classes.Navigation}>
            {data.cart ? (
              ...
              >
                {data.cart.map((object, i) => (
                  <MenuItem onClick={handleClose} key={i}>
                    <Typography>
                      {object.print.name} X {object.quantity} ={" "}
                    </Typography>
              ...
              <p>
                ...
                Nothing in the basket yet! Try clicking a shopping cart icon.
              </p>
            )}
