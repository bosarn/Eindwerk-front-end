...
import { setCarousel, advanceCarousel } from "../data/carousel";
...
export default (props) => {
  ...
  const BuyOneItem = (payload) => {
    ...
    dispatch(
      ToastDashMessage(`${payload.name} added to the shopping cart`, "info")
    );
  };
          ...
          {object.data.images ? (
            <CardMedia
              ...
              image={
                ...
                object.data.images[
                  carousel + 1 > object.data.images.length ? 0 : carousel
                ].path
              }
            />
          ) : (
        ...
        <Paper className={classes.description}>
          {object.data.description ? (
            <Typography
              ...
              dangerouslySetInnerHTML={{ __html: object.data.description }}
            ></Typography>
          ) : (
            "There is no description at the time, apologies!"
          )}
        </Paper>
        {object.data.size ? (
          <div>
